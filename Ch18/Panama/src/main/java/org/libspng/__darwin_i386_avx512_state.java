...
public class __darwin_i386_avx512_state {
    ...
    public static MemoryLayout $LAYOUT() {
        return __darwin_i386_avx512_state.$struct$LAYOUT;
    }
    ...
    public static VarHandle __fpu_ftw$VH() {
        return __darwin_i386_avx512_state.__fpu_ftw$VH;
    }
    public static byte __fpu_ftw$get(MemorySegment seg) {
        return (byte)__darwin_i386_avx512_state.__fpu_ftw$VH.get(seg);
    }
    public static void __fpu_ftw$set( MemorySegment seg, byte x) {
        __darwin_i386_avx512_state.__fpu_ftw$VH.set(seg, x);
    }
    public static byte __fpu_ftw$get(MemorySegment seg, long index) {
        return (byte)__darwin_i386_avx512_state.__fpu_ftw$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_ftw$set(MemorySegment seg, long index, byte x) {
        __darwin_i386_avx512_state.__fpu_ftw$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_rsrv1$VH() {
        return __darwin_i386_avx512_state.__fpu_rsrv1$VH;
    }
    public static byte __fpu_rsrv1$get(MemorySegment seg) {
        return (byte)__darwin_i386_avx512_state.__fpu_rsrv1$VH.get(seg);
    }
    public static void __fpu_rsrv1$set( MemorySegment seg, byte x) {
        __darwin_i386_avx512_state.__fpu_rsrv1$VH.set(seg, x);
    }
    public static byte __fpu_rsrv1$get(MemorySegment seg, long index) {
        return (byte)__darwin_i386_avx512_state.__fpu_rsrv1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_rsrv1$set(MemorySegment seg, long index, byte x) {
        __darwin_i386_avx512_state.__fpu_rsrv1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_fop$VH() {
        return __darwin_i386_avx512_state.__fpu_fop$VH;
    }
    public static short __fpu_fop$get(MemorySegment seg) {
        return (short)__darwin_i386_avx512_state.__fpu_fop$VH.get(seg);
    }
    public static void __fpu_fop$set( MemorySegment seg, short x) {
        __darwin_i386_avx512_state.__fpu_fop$VH.set(seg, x);
    }
    public static short __fpu_fop$get(MemorySegment seg, long index) {
        return (short)__darwin_i386_avx512_state.__fpu_fop$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_fop$set(MemorySegment seg, long index, short x) {
        __darwin_i386_avx512_state.__fpu_fop$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_ip$VH() {
        return __darwin_i386_avx512_state.__fpu_ip$VH;
    }
    public static int __fpu_ip$get(MemorySegment seg) {
        return (int)__darwin_i386_avx512_state.__fpu_ip$VH.get(seg);
    }
    public static void __fpu_ip$set( MemorySegment seg, int x) {
        __darwin_i386_avx512_state.__fpu_ip$VH.set(seg, x);
    }
    public static int __fpu_ip$get(MemorySegment seg, long index) {
        return (int)__darwin_i386_avx512_state.__fpu_ip$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_ip$set(MemorySegment seg, long index, int x) {
        __darwin_i386_avx512_state.__fpu_ip$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_cs$VH() {
        return __darwin_i386_avx512_state.__fpu_cs$VH;
    }
    public static short __fpu_cs$get(MemorySegment seg) {
        return (short)__darwin_i386_avx512_state.__fpu_cs$VH.get(seg);
    }
    public static void __fpu_cs$set( MemorySegment seg, short x) {
        __darwin_i386_avx512_state.__fpu_cs$VH.set(seg, x);
    }
    public static short __fpu_cs$get(MemorySegment seg, long index) {
        return (short)__darwin_i386_avx512_state.__fpu_cs$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_cs$set(MemorySegment seg, long index, short x) {
        __darwin_i386_avx512_state.__fpu_cs$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_rsrv2$VH() {
        return __darwin_i386_avx512_state.__fpu_rsrv2$VH;
    }
    public static short __fpu_rsrv2$get(MemorySegment seg) {
        return (short)__darwin_i386_avx512_state.__fpu_rsrv2$VH.get(seg);
    }
    public static void __fpu_rsrv2$set( MemorySegment seg, short x) {
        __darwin_i386_avx512_state.__fpu_rsrv2$VH.set(seg, x);
    }
    public static short __fpu_rsrv2$get(MemorySegment seg, long index) {
        return (short)__darwin_i386_avx512_state.__fpu_rsrv2$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_rsrv2$set(MemorySegment seg, long index, short x) {
        __darwin_i386_avx512_state.__fpu_rsrv2$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_dp$VH() {
        return __darwin_i386_avx512_state.__fpu_dp$VH;
    }
    public static int __fpu_dp$get(MemorySegment seg) {
        return (int)__darwin_i386_avx512_state.__fpu_dp$VH.get(seg);
    }
    public static void __fpu_dp$set( MemorySegment seg, int x) {
        __darwin_i386_avx512_state.__fpu_dp$VH.set(seg, x);
    }
    public static int __fpu_dp$get(MemorySegment seg, long index) {
        return (int)__darwin_i386_avx512_state.__fpu_dp$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_dp$set(MemorySegment seg, long index, int x) {
        __darwin_i386_avx512_state.__fpu_dp$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_ds$VH() {
        return __darwin_i386_avx512_state.__fpu_ds$VH;
    }
    public static short __fpu_ds$get(MemorySegment seg) {
        return (short)__darwin_i386_avx512_state.__fpu_ds$VH.get(seg);
    }
    public static void __fpu_ds$set( MemorySegment seg, short x) {
        __darwin_i386_avx512_state.__fpu_ds$VH.set(seg, x);
    }
    public static short __fpu_ds$get(MemorySegment seg, long index) {
        return (short)__darwin_i386_avx512_state.__fpu_ds$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_ds$set(MemorySegment seg, long index, short x) {
        __darwin_i386_avx512_state.__fpu_ds$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_rsrv3$VH() {
        return __darwin_i386_avx512_state.__fpu_rsrv3$VH;
    }
    public static short __fpu_rsrv3$get(MemorySegment seg) {
        return (short)__darwin_i386_avx512_state.__fpu_rsrv3$VH.get(seg);
    }
    public static void __fpu_rsrv3$set( MemorySegment seg, short x) {
        __darwin_i386_avx512_state.__fpu_rsrv3$VH.set(seg, x);
    }
    public static short __fpu_rsrv3$get(MemorySegment seg, long index) {
        return (short)__darwin_i386_avx512_state.__fpu_rsrv3$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_rsrv3$set(MemorySegment seg, long index, short x) {
        __darwin_i386_avx512_state.__fpu_rsrv3$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_mxcsr$VH() {
        return __darwin_i386_avx512_state.__fpu_mxcsr$VH;
    }
    public static int __fpu_mxcsr$get(MemorySegment seg) {
        return (int)__darwin_i386_avx512_state.__fpu_mxcsr$VH.get(seg);
    }
    public static void __fpu_mxcsr$set( MemorySegment seg, int x) {
        __darwin_i386_avx512_state.__fpu_mxcsr$VH.set(seg, x);
    }
    public static int __fpu_mxcsr$get(MemorySegment seg, long index) {
        return (int)__darwin_i386_avx512_state.__fpu_mxcsr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_mxcsr$set(MemorySegment seg, long index, int x) {
        __darwin_i386_avx512_state.__fpu_mxcsr$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_mxcsrmask$VH() {
        return __darwin_i386_avx512_state.__fpu_mxcsrmask$VH;
    }
    public static int __fpu_mxcsrmask$get(MemorySegment seg) {
        return (int)__darwin_i386_avx512_state.__fpu_mxcsrmask$VH.get(seg);
    }
    public static void __fpu_mxcsrmask$set( MemorySegment seg, int x) {
        __darwin_i386_avx512_state.__fpu_mxcsrmask$VH.set(seg, x);
    }
    public static int __fpu_mxcsrmask$get(MemorySegment seg, long index) {
        return (int)__darwin_i386_avx512_state.__fpu_mxcsrmask$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_mxcsrmask$set(MemorySegment seg, long index, int x) {
        __darwin_i386_avx512_state.__fpu_mxcsrmask$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle __fpu_reserved1$VH() {
        return __darwin_i386_avx512_state.__fpu_reserved1$VH;
    }
    public static int __fpu_reserved1$get(MemorySegment seg) {
        return (int)__darwin_i386_avx512_state.__fpu_reserved1$VH.get(seg);
    }
    public static void __fpu_reserved1$set( MemorySegment seg, int x) {
        __darwin_i386_avx512_state.__fpu_reserved1$VH.set(seg, x);
    }
    public static int __fpu_reserved1$get(MemorySegment seg, long index) {
        return (int)__darwin_i386_avx512_state.__fpu_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __fpu_reserved1$set(MemorySegment seg, long index, int x) {
        __darwin_i386_avx512_state.__fpu_reserved1$VH.set(seg.asSlice(index*sizeof()), x);
    }
