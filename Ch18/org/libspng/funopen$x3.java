...
public interface funopen$x3 {
    ...
    static MemoryAddress allocate(funopen$x3 fi) {
        return RuntimeHelper.upcallStub(funopen$x3.class, fi, constants$43.funopen$x3$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)I");
    }
    static MemoryAddress allocate(funopen$x3 fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(funopen$x3.class, fi, constants$43.funopen$x3$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)I", scope);
    }
