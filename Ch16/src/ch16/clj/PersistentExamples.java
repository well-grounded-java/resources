...
//        System.out.println("vector.root.array[0] : " + Arrays.toString(((PersistentVector.Node) (vector.root.array[0])).array));
//        System.out.println("vector.root.array[30]: " + Arrays.toString(((PersistentVector.Node) (vector.root.array[30])).array));
//        System.out.println("----------------");
        ...
        System.out.println("vector.root.array[0] : " + Arrays.toString(vRA0.array));
        System.out.println("vector.root.array[1] : " + Arrays.toString(vRA1.array));
        ...
        System.out.println("vector.root.array[0].array[0] : " + Arrays.toString(vRA0A0.array));
        System.out.println("vector.root.array[0].array[31] : " + Arrays.toString(vRA0A31.array));
        System.out.println("vector.root.array[1].array[0] : " + Arrays.toString(vRA1A0.array));
    }
