...
public class spng_h extends spng_h_1 {
    ...
    public static MethodHandle zopen$MH() {
        return RuntimeHelper.requireNonNull(constants$41.zopen$MH,"zopen");
    }
    public static MemoryAddress zopen ( Addressable x0,  Addressable x1,  int x2) {
        var mh$ = RuntimeHelper.requireNonNull(constants$41.zopen$MH, "zopen");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact(x0.address(), x1.address(), x2);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle __vsnprintf_chk$MH() {
        return RuntimeHelper.requireNonNull(constants$44.__vsnprintf_chk$MH,"__vsnprintf_chk");
    }
    public static int __vsnprintf_chk ( Addressable x0,  long x1,  int x2,  long x3,  Addressable x4,  Addressable x5) {
        var mh$ = RuntimeHelper.requireNonNull(constants$44.__vsnprintf_chk$MH, "__vsnprintf_chk");
        try {
    ...
    public static MethodHandle spng_set_png_buffer$MH() {
        return RuntimeHelper.requireNonNull(constants$47.spng_set_png_buffer$MH,"spng_set_png_buffer");
    }
    public static int spng_set_png_buffer ( Addressable ctx,  Addressable buf,  long size) {
        var mh$ = RuntimeHelper.requireNonNull(constants$47.spng_set_png_buffer$MH, "spng_set_png_buffer");
        try {
    ...
    public static MethodHandle spng_set_chunk_limits$MH() {
        return RuntimeHelper.requireNonNull(constants$48.spng_set_chunk_limits$MH,"spng_set_chunk_limits");
    }
    public static int spng_set_chunk_limits ( Addressable ctx,  long chunk_size,  long cache_size) {
        var mh$ = RuntimeHelper.requireNonNull(constants$48.spng_set_chunk_limits$MH, "spng_set_chunk_limits");
        try {
    ...
    public static MethodHandle spng_decode_image$MH() {
        return RuntimeHelper.requireNonNull(constants$49.spng_decode_image$MH,"spng_decode_image");
    }
    public static int spng_decode_image ( Addressable ctx,  Addressable out,  long len,  int fmt,  int flags) {
        var mh$ = RuntimeHelper.requireNonNull(constants$49.spng_decode_image$MH, "spng_decode_image");
        try {
    ...
    public static MethodHandle spng_encode_scanline$MH() {
        return RuntimeHelper.requireNonNull(constants$50.spng_encode_scanline$MH,"spng_encode_scanline");
    }
    public static int spng_encode_scanline ( Addressable ctx,  Addressable scanline,  long len) {
        var mh$ = RuntimeHelper.requireNonNull(constants$50.spng_encode_scanline$MH, "spng_encode_scanline");
        try {
    ...
    public static MethodHandle spng_get_chrm$MH() {
        return RuntimeHelper.requireNonNull(constants$51.spng_get_chrm$MH,"spng_get_chrm");
    }
    public static int spng_get_chrm ( Addressable ctx,  Addressable chrm) {
        var mh$ = RuntimeHelper.requireNonNull(constants$51.spng_get_chrm$MH, "spng_get_chrm");
        try {
    ...
    public static MethodHandle spng_get_srgb$MH() {
        return RuntimeHelper.requireNonNull(constants$52.spng_get_srgb$MH,"spng_get_srgb");
    }
    public static int spng_get_srgb ( Addressable ctx,  Addressable rendering_intent) {
        var mh$ = RuntimeHelper.requireNonNull(constants$52.spng_get_srgb$MH, "spng_get_srgb");
        try {
    ...
    public static MethodHandle spng_get_time$MH() {
        return RuntimeHelper.requireNonNull(constants$53.spng_get_time$MH,"spng_get_time");
    }
    public static int spng_get_time ( Addressable ctx,  Addressable time) {
        var mh$ = RuntimeHelper.requireNonNull(constants$53.spng_get_time$MH, "spng_get_time");
        try {
    ...
    public static MethodHandle spng_set_trns$MH() {
        return RuntimeHelper.requireNonNull(constants$54.spng_set_trns$MH,"spng_set_trns");
    }
    public static int spng_set_trns ( Addressable ctx,  Addressable trns) {
        var mh$ = RuntimeHelper.requireNonNull(constants$54.spng_set_trns$MH, "spng_set_trns");
        try {
            return (int)mh$.invokeExact(ctx.address(), trns.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle spng_set_sbit$MH() {
        return RuntimeHelper.requireNonNull(constants$55.spng_set_sbit$MH,"spng_set_sbit");
    }
    public static int spng_set_sbit ( Addressable ctx,  Addressable sbit) {
        var mh$ = RuntimeHelper.requireNonNull(constants$55.spng_set_sbit$MH, "spng_set_sbit");
        try {
            return (int)mh$.invokeExact(ctx.address(), sbit.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MethodHandle spng_set_splt$MH() {
        return RuntimeHelper.requireNonNull(constants$56.spng_set_splt$MH,"spng_set_splt");
    }
    public static int spng_set_splt ( Addressable ctx,  Addressable splt,  int n_splt) {
        var mh$ = RuntimeHelper.requireNonNull(constants$56.spng_set_splt$MH, "spng_set_splt");
        try {
    ...
    public static MethodHandle spng_version_string$MH() {
        return RuntimeHelper.requireNonNull(constants$57.spng_version_string$MH,"spng_version_string");
    }
    public static MemoryAddress spng_version_string () {
        var mh$ = RuntimeHelper.requireNonNull(constants$57.spng_version_string$MH, "spng_version_string");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact();
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MemoryAddress SIG_IGN() {
        return constants$58.SIG_IGN$ADDR;
    }
